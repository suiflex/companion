...
export const id: Record<keyof typeof en, string> = {
  ...
  'ext.settings.tab.version': 'Versi',
  ...
  'ext.sidebar.knowledge': 'Konteks & Istilah',
  ...
  'ext.kb.tabContexts': 'Mini Context',
  'ext.kb.tabInsights': 'Wawasan Rapat',
  'ext.kb.contextTitle': 'Mini Konteks & Istilah',
  'ext.kb.contextDesc':
    'Kelola singkatan, istilah domain, atau detail bahasan tim agar dapat disisipkan ke rapat dan dipahami AI.',
  'ext.kb.addContext': 'Tambah Konteks',
  'ext.kb.editContext': 'Edit Konteks',
  'ext.kb.term': 'Istilah / Singkatan',
  'ext.kb.termPlaceholder': 'misal: P95 Latency, SIEM, OKR',
  'ext.kb.definition': 'Definisi / Konteks Detail',
  'ext.kb.definitionPlaceholder': 'Jelaskan arti singkatan atau konteks bahasan ini…',
  'ext.kb.tags': 'Tag',
  'ext.kb.tagsPlaceholder': 'Ketik nama tag (tekan Enter untuk menambah)…',
  'ext.kb.selectExistingTags': 'Pilih dari tag yang ada:',
  'ext.kb.addTag': 'Tambah',
  'ext.kb.selectedTags': 'Tag terpilih',
  'ext.kb.removeTag': 'Hapus tag {tag}',
  'ext.kb.clickToEdit': 'Klik untuk edit',
  'ext.kb.saveContext': 'Simpan Konteks',
  'ext.kb.cancel': 'Batal',
  'ext.kb.allTags': 'Semua',
  'ext.kb.searchContexts': 'Cari istilah atau definisi…',
  'ext.kb.noContexts': 'Belum ada mini konteks. Klik "Tambah Konteks" di atas untuk membuat baru.',
  'ext.kb.noMatchingContexts': 'Tidak ada konteks yang cocok.',
  'ext.kb.deleteContext': 'Hapus',
  'ext.kb.edit': 'Edit',
  'ext.kb.contextSaved': 'Konteks tersimpan.',
  'ext.kb.contextDeleted': 'Konteks dihapus.',
  'ext.header.insertContext': 'Sisipkan Konteks',
  'ext.header.contextPopoverTitle': 'Sisipkan Konteks ke Rapat',
  ...
  // -- extension: version & guides -----------------------------------------
  'ext.version.title': 'Versi & Panduan Instalasi',
  'ext.version.current': 'Versi Saat Ini: v{version}',
  'ext.version.chromeTitle': 'Google Chrome & Chromium',
  'ext.version.chromeStep1': 'Buka chrome://extensions di browser Anda.',
  'ext.version.chromeStep2': 'Aktifkan "Mode Pengembang" di pojok kanan atas.',
  'ext.version.chromeStep3': 'Klik "Muat yang belum dibongkar" lalu pilih folder apps/extension/dist.',
  'ext.version.chromeStep4': 'Untuk update, bangun ulang dengan make build-extension lalu klik ikon reload (↻).',
  'ext.version.firefoxTitle': 'Mozilla Firefox',
  'ext.version.firefoxStep1': 'Buka about:debugging#/runtime/this-firefox di Firefox.',
  'ext.version.firefoxStep2': 'Klik "Muat Add-on Sementara…".',
  'ext.version.firefoxStep3': 'Pilih file manifest.json di dalam folder apps/extension/dist.',
  'ext.version.firefoxStep4': 'Untuk update, klik tombol "Reload" pada kartu add-on Companion.',
  'ext.version.desktopTitle': 'Aplikasi Desktop (Prebuilt Binary)',
  'ext.version.desktopDesc': 'Aplikasi desktop Companion dengan local Markdown vault, sinkronisasi latar belakang, dan native host.',
  'ext.version.downloadReleases': 'GitHub Releases',
  'ext.version.downloadZip': 'Unduh Ekstensi (ZIP)',
  'ext.version.platformMac': 'macOS (DMG)',
  'ext.version.platformWindows': 'Windows (MSI/EXE)',
  'ext.version.platformLinux': 'Linux (DEB/Tar)',
  'ext.version.terminalTitle': 'Instalasi via Terminal',
  'ext.version.terminalDesc': 'Satu perintah untuk pasang Companion Desktop dan membuka pemilih browser:',
  'ext.version.copiedCommand': 'Perintah berhasil disalin.',
  'ext.version.copy': 'Salin',
