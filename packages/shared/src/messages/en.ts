...
export const en = {
  ...
  'ext.settings.tab.version': 'Version',
  ...
  'ext.sidebar.knowledge': 'Mini Contexts & Glossary',
  ...
  'ext.kb.tabContexts': 'Mini Contexts',
  'ext.kb.tabInsights': 'Meeting Insights',
  'ext.kb.contextTitle': 'Mini Context & Glossary',
  'ext.kb.contextDesc':
    'Define terms, abbreviations, and project contexts to easily insert into meetings for AI accuracy.',
  'ext.kb.addContext': 'Add Context',
  'ext.kb.editContext': 'Edit Context',
  'ext.kb.term': 'Term / Abbreviation',
  'ext.kb.termPlaceholder': 'e.g. P95 Latency, SIEM, OKR',
  'ext.kb.definition': 'Definition / Details',
  'ext.kb.definitionPlaceholder': 'Explain what this term or abbreviation means in your team…',
  'ext.kb.tags': 'Tags',
  'ext.kb.tagsPlaceholder': 'Type tag name (press Enter to add)…',
  'ext.kb.selectExistingTags': 'Select from existing tags:',
  'ext.kb.addTag': 'Add',
  'ext.kb.selectedTags': 'Selected tags',
  'ext.kb.removeTag': 'Remove tag {tag}',
  'ext.kb.clickToEdit': 'Click to edit',
  'ext.kb.saveContext': 'Save Context',
  'ext.kb.cancel': 'Cancel',
  'ext.kb.allTags': 'All',
  'ext.kb.searchContexts': 'Search terms or definitions…',
  'ext.kb.noContexts': 'No contexts added yet. Click "Add Context" above to create one.',
  'ext.kb.noMatchingContexts': 'No matching contexts found.',
  'ext.kb.deleteContext': 'Delete',
  'ext.kb.edit': 'Edit',
  'ext.kb.contextSaved': 'Context saved.',
  'ext.kb.contextDeleted': 'Context deleted.',
  'ext.header.insertContext': 'Insert Context',
  'ext.header.contextPopoverTitle': 'Insert Context into Meeting',
  ...
  'ext.version.title': 'Companion Version & Installation',
  'ext.version.current': 'Current Version: v{version}',
  'ext.version.chromeTitle': 'Google Chrome & Chromium',
  'ext.version.chromeStep1': 'Open chrome://extensions in your browser.',
  'ext.version.chromeStep2': 'Turn on Developer mode in the top right corner.',
  'ext.version.chromeStep3': 'Click "Load unpacked" and select the apps/extension/dist directory.',
  'ext.version.chromeStep4': 'To update, rebuild with make build-extension and click the reload icon (↻).',
  'ext.version.firefoxTitle': 'Mozilla Firefox',
  'ext.version.firefoxStep1': 'Open about:debugging#/runtime/this-firefox in Firefox.',
  'ext.version.firefoxStep2': 'Click "Load Temporary Add-on…".',
  'ext.version.firefoxStep3': 'Select manifest.json inside the apps/extension/dist directory.',
  'ext.version.firefoxStep4': 'To update, click "Reload" on the Companion add-on card.',
  'ext.version.desktopTitle': 'Desktop App (Prebuilt Binary)',
  'ext.version.desktopDesc': 'Companion desktop app with local Markdown vault, background sync, and native messaging host.',
  'ext.version.downloadReleases': 'GitHub Releases',
  'ext.version.downloadZip': 'Download Extension (ZIP)',
  'ext.version.platformMac': 'macOS (DMG)',
  'ext.version.platformWindows': 'Windows (MSI/EXE)',
  'ext.version.platformLinux': 'Linux (DEB/Tar)',
  'ext.version.terminalTitle': 'Install via Terminal',
  'ext.version.terminalDesc': 'One command installs Companion Desktop and launches the browser picker:',
  'ext.version.copiedCommand': 'Command copied to clipboard.',
  'ext.version.copy': 'Copy',
